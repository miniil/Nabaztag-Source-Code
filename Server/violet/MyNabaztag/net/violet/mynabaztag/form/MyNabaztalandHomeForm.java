...
public final class MyNabaztalandHomeForm extends AbstractForm {

	private static final long serialVersionUID = 1L;

	private String languser = StringShop.EMPTY_STRING;
	private String langCategorie = StringShop.EMPTY_STRING;
	...
	private List<NabcastData> listNabcast = new ArrayList<NabcastData>();
	 ...
	 */
	public void setNabcastCateg(int idCateg) {
		this.nabcastCateg = idCateg;
	}
	...
	/**
	 * @return the langCateg
	 */
	public String getLangCategorie() {
		return this.langCategorie;
	}

	/**
	 * @param langCateg the langCateg to set
	 */
	public void setLangCategorie(String langCategorie) {
		this.langCategorie = langCategorie;
	}

	/**
	 * @return the listNabcast
	 */
	public List<NabcastData> getListNabcast() {
		return this.listNabcast;
	}

	/**
	 * @param listNabcast the listNabcast to set
	 */
	public void setListNabcast(List<NabcastData> listNabcast) {
		this.listNabcast = listNabcast;
	}
