...
public final class MyNabaztalandSubscribeForm extends AbstractForm {
	...
	private int languser = 1;
	private NabcastData nabcastData = new NabcastData();
	private String heures = StringShop.EMPTY_STRING;
	private String minutes = StringShop.EMPTY_STRING;
	private int isReg;
