...
<br/>
	<ul class="genericBigList">
		<li>
			<%=DicoTools.dico(dico_lang , "main/please_connect")%>
			<div>
				<html:form action="/action/mySession" styleId="login_form">
					...
					<div class="inline-login">
						...
						<div class="thirdCol">
							<label><%=DicoTools.dico(dico_lang , "myHome/nabname")%></label>
							<html:text name="mySessionForm" property="pseudo"/>
						</div>
						
						<div class="thirdCol">
							<label><%=DicoTools.dico(dico_lang , "myHome/motdepasse")%></label>
		...
		<li>
			<%=DicoTools.dico(dico_lang , "main/discover_nabaztag")%>
		</li>		
	</ul>	