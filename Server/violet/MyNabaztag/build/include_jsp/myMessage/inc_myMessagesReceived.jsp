...
<table width="100%" cellspacing="0" cellpadding="0" class="messagesListeTable" id="messagesListeReceived">
			...
			<logic:iterate name="myMessagesListForm" property="listeMessages" id="messageReceivedData">
				...
				<bean:define name="messageReceivedData" property="url" id="event_url"/>
					<tr>		
						...
						<td>
						<a onclick="loadPersoPlayer('<%=event_url%>', '100%', true, 'myPlayerMp3_r')" title="Ecouter" href="javascript:;">
	...
	<ul class="messages-list-func">
		<li><a href="javascript:;" onclick="messages_select_all('messagesListeReceived')"><%=DicoTools.dico(dico_lang, "myMessages/select_all")%></a></li>
		<li>
			<logic:equal name="myMessagesListForm" property="nabcast" value="0">
				<a href="javascript:void(0);" onclick="divChangeUrl('contentRecu' , '../action/myMessagesList.do?action=received&index=<%=index%>&nabcast=1');"><%=DicoTools.dico(dico_lang, "myMessages/display_nabcast")%></a>
			</logic:equal>
			
			<logic:equal name="myMessagesListForm" property="nabcast" value="1">
				<a href="javascript:void(0);" onclick="divChangeUrl('contentRecu' , '../action/myMessagesList.do?action=received&index=<%=index%>&nabcast=0');"><%=DicoTools.dico(dico_lang, "myMessages/no_display_nabcasts")%></a>
			</logic:equal>
		</li>
	...
	<div class="messages-select-action">
		<select name="selectChoice" style="width:120px;">
			...
			<option value="archive_msg" selected="selected"><%=DicoTools.dico(dico_lang, "myMessages/archive")%></option>
			<option value="delete_msg"><%=DicoTools.dico(dico_lang, "myMessages/delete")%></option>
			<option value="replay_msg"><%=DicoTools.dico(dico_lang, "myMessages/replay")%></option>
			<option value="blacklist"><%=DicoTools.dico(dico_lang, "myMessages/blacklist")%></option>
		</select>
		<input type="button" value="<%=DicoTools.dico(dico_lang, "myMessages/button_ok")%>" class="genericBt" onclick="submitAjaxForm('update_list','contentRecu');"/> 	
	</div>
...
<div class="paginate">
	<ul>
		<form action="../action/myMessagesList.do" name="pageSelector" method="post" >
			...
			<li>
				<a href="javascript:;" onclick="messagesChangePage('contentRecu', <bean:write name="myMessagesListForm" property="page_indexD" />)"> &lt;&lt; </a>
			</li>
			
			<li>
				<a href="javascript:;" onclick="messagesChangePage('contentRecu', <bean:write name="myMessagesListForm" property="page_indexM" />)"> &lt; </a>
			</li>

			<logic:notEqual name="myMessagesListForm" property="page_indexMM" value="0">
				<li>
					<a href="javascript:;" onclick="messagesChangePage('contentRecu', <bean:write name="myMessagesListForm" property="page_indexMM" />)"> <bean:write name="myMessagesListForm" property="page_AffIndexMM" /> </a>
				</li>
			</logic:notEqual>
			
			<logic:notEqual name="myMessagesListForm" property="page_indexM" value="0">
				<li>
					<a href="javascript:;" onclick="messagesChangePage('contentRecu', <bean:write name="myMessagesListForm" property="page_indexM" />)"> <bean:write name="myMessagesListForm" property="page_AffIndexM" /> </a>
				</li>
			</logic:notEqual>
			...
			<logic:notEqual name="myMessagesListForm" property="page_indexP" value="0">
				<li>
					<a href="javascript:;" onclick="messagesChangePage('contentRecu', <bean:write name="myMessagesListForm" property="page_indexP" />)"> <bean:write name="myMessagesListForm" property="page_AffIndexP" /></a>
				</li>
			</logic:notEqual>
			
			<logic:notEqual name="myMessagesListForm" property="page_indexPP" value="0">
				<li>
					<a href="javascript:;" onclick="messagesChangePage('contentRecu', <bean:write name="myMessagesListForm" property="page_indexPP" />)"> <bean:write name="myMessagesListForm" property="page_AffIndexPP" /></a>
				</li>
			</logic:notEqual>

			<li>
				<logic:equal name="myMessagesListForm" property="page_indexP" value="0">
					<a href="javascript:;" onclick="messagesChangePage('contentRecu', <bean:write name="myMessagesListForm" property="page_indexF" />)"> &gt; </a>
				</logic:equal>
				<logic:notEqual name="myMessagesListForm" property="page_indexP" value="0">
					<a href="javascript:;" onclick="messagesChangePage('contentRecu', <bean:write name="myMessagesListForm" property="page_indexP" />)"> &gt; </a>
				</logic:notEqual>						
			</li>
