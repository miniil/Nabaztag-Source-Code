...
<div id="gmailConfig" class="main-cadre-contener">	
	...
	<div class="main-cadre-content">
		<!-- ******************************************** CONTENT ***************************************************** --> 
			<html:form action="/action/srvGmailConfig" styleId="srvGmailConfig" styleClass="srvConfigForm">

				<div>
					<label><%=DicoTools.dico(dico_lang , "srv_gmail/login")%> </label>
					<input style="width:30%;" type="text" id="login" name="login" value="<bean:write name="mySrvGmailForm" property="login"/>" />
				</div>
						
				<hr class="spacer">
				
				<div>
					<label><%=DicoTools.dico(dico_lang , "srv_gmail/password")%> </label>
					<input style="width:30%; padding:2px;" type="password" id="password" name="password" value="<bean:write name="mySrvGmailForm" property="password"/>" />
				</div>
				...
				<hr class="spacer">
					...
					<html:select property="gmailLang" style="width:150px;">
					<logic:iterate name="mySrvGmailForm" property="langList" id="langData">
			...
			<div align="center">
				<logic:notEmpty name="mySrvGmailForm" property="login">
					<%-- Delete --%>			
				...
				<logic:empty name="mySrvGmailForm" property="login" >
					<%-- Activate --%>				
