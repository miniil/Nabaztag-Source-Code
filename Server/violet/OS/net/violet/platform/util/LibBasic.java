...
public class LibBasic {
	...
	static final Logger LOGGER = Logger.getLogger(LibBasic.class);
	...
	public static String getStringFromBytes(byte[] inBytes, String inCharset) {
		try {
			return (inBytes != null) ? new String(inBytes, (inCharset != null) ? inCharset : LibBasic.CHARSET) : net.violet.common.StringShop.EMPTY_STRING;
		} catch (final UnsupportedEncodingException e) {
			LibBasic.LOGGER.fatal(e, e);
		}
